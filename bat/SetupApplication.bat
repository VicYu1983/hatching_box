...
:: Android packaging
set AND_CERT_NAME="HatchingBox2"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\HatchingBox2.p12
...
set IOS_PROVISION=cert\HatchingBox2.mobileprovision
...
set APP_ID=air.HatchingBox2

:: Output packages
set DIST_PATH=dist
set DIST_NAME=HatchingBox2
